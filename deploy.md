...
2.  From the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}, search for Watsonx.ai SaaS with Assistant and Governance, and click the tile for the deployable architecture.
